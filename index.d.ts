declare namespace Backbone {
  ...
  declare module grapesjs {
    ...
    */
    ...
    interface PropertyComposite<T extends PropertyCompositeOptions> extends Property<T> {
      /**
       * Get properties.
       */
    ...
    type AnyProperty = Property<PropertyOptions> | PropertyNumber | PropertySelect | PropertyComposite<PropertyCompositeOptions> | PropertyStack;
    ...
    */
    interface UndoManager {
       ...
       */
      add(entity: Backbone.GenericModel | Backbone.Collection<Backbone.GenericModel>): UndoManager;
      /**
       ...
       */
      remove(entity: Backbone.GenericModel | Backbone.Collection<Backbone.GenericModel>): UndoManager;
      /**
       * Remove all entities
       * @example
       * um.removeAll();
       ...
       * @param entity - Entity to track
       */
      isRegistered(entity: Backbone.GenericModel | Backbone.Collection<Backbone.GenericModel>): boolean;
      /**
