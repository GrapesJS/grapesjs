import { StringOperator, StringOperation } from "../../../../../../src/data_sources/model/conditional_variables/operators/StringOperations";
...
describe('StringOperator', () => {
    ...
    describe('Edge Case Tests', () => {
        ...
        test('should throw error for unsupported operator', () => {
            ...
            expect(() => operator.evaluate('test', 'test')).toThrow(
                'Unsupported string operator: unsupported'
            );
        });
    });
});
