import { NumberOperator, NumberOperation } from "../../../../../../src/data_sources/model/conditional_variables/operators/NumberOperator";
...
describe('NumberOperator', () => {
    ...
    describe('Edge Case Tests', () => {
        ...
        test('should throw error for unsupported operator', () => {
            ...
            expect(() => operator.evaluate(1, 2)).toThrow(
                'Unsupported number operator: unsupported'
            );
        });
    });
});
