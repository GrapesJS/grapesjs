import { LogicalOperator, LogicalOperation } from "../../../../../../src/data_sources/model/conditional_variables/operators/LogicalOperator";
...
describe('LogicalOperator', () => {
    ...
    describe('Edge Case Tests', () => {
        ...
        test('should throw error for unsupported operator', () => {
            ...
            expect(() => operator.evaluate([true, false])).toThrow(
                'Unsupported logical operator: unsupported'
            );
        });
    });
});
