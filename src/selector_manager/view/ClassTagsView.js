...
export default class ClassTagsView extends Backbone.View {
    template({
            labelInfo,
            labelStates,
            labelHead,
...
ClassTagsView.prototype.events = {
...
ClassTagsView.prototype.componentChanged = debounce(function({ targets } = {}) {
    this.updateSelection(targets);
  });
ClassTagsView.prototype.checkSync = debounce(function() {
